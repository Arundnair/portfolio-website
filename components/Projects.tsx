...
const ProjectCard: React.FC<{ project: Project; index: number }> = memo(({ project, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 -z-10 opacity-30 md:opacity-0 group-hover:opacity-100 transition-opacity duration-1000" aria-hidden="true">
                <motion.div 
                    animate={{ 
                        scale: [1, 1.2, 1],
                        x: [0, 50, 0],
            ...
            <div className="absolute top-0 left-0 w-6 md:w-8 h-6 md:h-8 border-t-2 border-l-2 border-black/10 dark:border-white/20 group-hover:border-neon-blue transition-colors duration-500 rounded-tl-3xl" aria-hidden="true" />
            <div className="absolute bottom-0 right-0 w-6 md:w-8 h-6 md:h-8 border-b-2 border-r-2 border-black/10 dark:border-white/20 group-hover:border-neon-purple transition-colors duration-500 rounded-br-3xl" aria-hidden="true" />
                    ...
                    <div className="flex justify-between items-start mb-4 md:mb-6">
                        ...
                        <div className="flex gap-2 md:gap-3">
                            <a 
                                ...
                                className="p-2 md:p-2.5 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 rounded-xl border border-black/5 dark:border-white/10 transition-all duration-300 text-gray-600 dark:text-white/70 hover:text-black dark:hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue" 
                                data-hover="true"
                            >
                            ...
                            <a 
                                ...
                                className="p-2 md:p-2.5 bg-neon-blue/10 hover:bg-neon-blue/20 rounded-xl border border-neon-blue/20 transition-all duration-300 text-neon-blue/70 hover:text-neon-blue focus:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue" 
                                data-hover="true"
                            >
                                <ExternalLink className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" />
                            </a>
                        </div>
                    </div>
            ...
            <div className="absolute top-0 left-0 w-full h-[1px] bg-white/20 blur-[1px] -translate-y-full group-hover:animate-scanline pointer-events-none" aria-hidden="true" />
        </motion.article>
    );
});
...
const Projects: React.FC = () => {
  return (
    <section 
      className="py-24 md:py-32 px-4 md:px-12 max-w-7xl mx-auto overflow-hidden" 
      id="projects"
    ...
    >
        ...
        >
            ...
            <h2 id="projects-heading" className="text-4xl md:text-8xl font-display font-bold text-gray-900 dark:text-white mb-4 md:mb-6 tracking-tighter">
