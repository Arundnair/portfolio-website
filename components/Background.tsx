...
const Background: React.FC<BackgroundProps> = memo(({ theme }) => {
    ...
    return (
        <div 
          className={`fixed inset-0 z-[-1] overflow-hidden transition-colors duration-500 ${theme === 'dark' ? 'bg-[#030305]' : 'bg-[#f9fafb]'}`}
          aria-hidden="true"
        >
             {/* Starfield Canvas */}
