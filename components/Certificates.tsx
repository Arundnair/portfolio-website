    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
            ...
            <h2 id="certificates-heading" className="text-4xl md:text-6xl font-display font-bold mb-4 text-gray-900 dark:text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {CERTIFICATES.map((cert, index) => (
                <motion.article
                    ...
                    aria-label={`Certificate: ${cert.title} from ${cert.issuer}`}
                >
                    {/* Tech Border Decorations */}
                    <div className="absolute -inset-[1px] bg-gradient-to-b from-neon-blue/30 to-neon-purple/30 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm" aria-hidden="true" />
                    ...
                    <div className="relative bg-white dark:bg-[#0a0a0a] border border-black/5 dark:border-white/10 rounded-lg overflow-hidden hover:border-black/20 dark:hover:border-white/30 transition-colors duration-500 flex flex-col h-full shadow-lg dark:shadow-none">
                        ...
                        <div className="relative h-48 w-full overflow-hidden bg-gray-100 dark:bg-white/5 group">
                            ...
                            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex items-center justify-center gap-4">
                                <a 
                                    ...
                                    className="p-3 bg-neon-blue/20 hover:bg-neon-blue/40 rounded-full text-neon-blue backdrop-blur-md transform scale-0 group-hover:scale-100 transition-all duration-300 delay-75 focus:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue"
                                >
                            ...
                            {/* Corner Decals */}
                            <div className="absolute top-2 left-2 w-2 h-2 border-t border-l border-neon-blue opacity-50" aria-hidden="true" />
                            <div className="absolute top-2 right-2 w-2 h-2 border-t border-r border-neon-blue opacity-50" aria-hidden="true" />
                            <div className="absolute bottom-2 left-2 w-2 h-2 border-b border-l border-neon-blue opacity-50" aria-hidden="true" />
                            <div className="absolute bottom-2 right-2 w-2 h-2 border-b border-r border-neon-blue opacity-50" aria-hidden="true" />
                        </div>
                        ...
                        <div className="p-6 flex flex-col flex-grow relative">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-xs mb-4 flex items-center gap-2">
                                <ShieldCheck size={12} className="text-neon-blue" aria-hidden="true" />
                                {cert.issuer}
                            </p>
