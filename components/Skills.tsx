...
const Skills: React.FC = () => {
  return (
    <section className="py-20 md:py-24 relative overflow-hidden" id="skills">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:20px_20px] md:bg-[size:24px_24px] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            ...
            >
                <h2 className="text-3xl md:text-5xl font-display font-bold mb-4 text-gray-900 dark:text-white">
