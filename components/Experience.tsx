...
const Experience: React.FC = () => {
  return (
    <section className="py-32 relative bg-black/5 dark:bg-black/20" id="experience">
                    ...
                    >
                        <div className={`md:flex items-center group ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                            ...
                            <div className="md:w-1/2 px-8">
                                ...
                                >
                                    <div className="absolute top-0 right-0 p-4 opacity-5 dark:opacity-10 group-hover:opacity-10 dark:group-hover:opacity-20 transition-opacity text-black dark:text-white">
                            ...
                            <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 items-center justify-center">
                              <motion.div 
                                initial={{ scale: 0 }}
                                whileInView={{ scale: 1 }}
                                viewport={{ once: true }}
