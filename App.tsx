  ...
  return (
    <div className="min-h-screen font-sans overflow-x-hidden relative selection:bg-neon-blue selection:text-black">
      ...
      >
        ...
        <div className="fixed inset-0 pointer-events-none z-[9991] bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.1)_100%)] dark:bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.5)_100%)] transition-colors duration-500" />
      </motion.div>
    </div>
  );
};
